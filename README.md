...
It includes dropdown equipment selection, expanded inverter catalogs, expanded panel catalogs, battery selection, preliminary electrical checks, recommended panels-per-string range, and a starter mounting quantity module.
