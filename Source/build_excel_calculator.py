...
OUTPUT = ROOT / "Excel" / "Line-Energy-Solar-Calculator-v0.20.xlsx"
...
def build() -> None:
    ...
    inputs = [
        ["Line-Energy Solar Calculator", "v0.20.0-draft"],
    ...
    sheets = [
        Sheet(
            "Summary",
            [
                ["Line-Energy Solar Designer", "v0.20.0-draft", "", ""],
            ...
            styles={**range_styles([["Line-Energy Solar Designer", "v0.20.0-draft", "", ""], ["Item", "Value", "Unit", "Status / Note"]], header_row=2, title_row=1), **{f"B{row}": 3 for row in range(3, 47)}},
