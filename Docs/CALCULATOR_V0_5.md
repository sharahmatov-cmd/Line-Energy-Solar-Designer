# Excel Calculator v0.5

File:

`Excel/Line-Energy-Solar-Calculator-v0.5.xlsx`
...
The mounting calculation is a starter estimate. Final quantities must be verified against the selected mounting supplier, roof layout, wind/snow loads, rail span tables, and local installation requirements.
