...
- `Regions` - annual and monthly solar yield assumptions.
...
- `Costs` - price assumptions for equipment, mounting materials, cable, protection, delivery, and installation work.
